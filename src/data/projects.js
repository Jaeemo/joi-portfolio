export const rgbProjects = [
    {
        ...
        title: "TOOTH FAIRY",
        year: "2025",
        descriptionKo: `베개 아래에 천사가 살고 있다<span class="font-pretendard">.</span>
잠을 잘 때<span class="font-pretendard">,</span> 달콤한 천사의 속삭임에 잇몸이 녹아내린다<span class="font-pretendard">.</span>
빠진 치아는 반드시 꼼꼼히 닦길<span class="font-pretendard">.</span>
달콤한 천사가 기다리고 있다<span class="font-pretendard">.</span>
...
(Perhaps the devil of tooth decay.)</b>`,
    ...
    },
    {
        ...
        year: "2025",
        descriptionKo: `<b><span class="font-pretendard">3D</span></b> 프린팅 키링<span class="font-pretendard">,</span> 캔들 홀더`,
        ...
        imageLayout: [
            ...
            // New Text Section
            {
                ...
                descKo: `당신은 정말 ‘그’ 아이돌을 ‘좋아’합니까<b><span class="font-pretendard">?</span></b>
네 명의 캐릭터로 구성된 <b><span class="font-pretendard">ANGELITE</span></b>는 모두 하나의 디자이너의 움직임을 기반으로 만들어졌다<span class="font-pretendard">.</span> 모션 트래킹 기술을 통해 디자이너의 몸짓을 실시간으로 반영하며<span class="font-pretendard">,</span> 음성은 <b><span class="font-pretendard">AI</span></b> 기반 변조를 통해 각기 다른 인격과 감정<span class="font-pretendard">,</span> 말투를 갖춘 개별 캐릭터로 연기된다<span class="font-pretendard">.</span> 겉보기에 이들은 실존하는 인물처럼 보이지만<span class="font-pretendard">,</span> 실체는 오직 하나뿐이다<span class="font-pretendard">.</span>
이 프로젝트는 우리가 ‘연예인’이라는 존재를 어떻게 소비하고<span class="font-pretendard">,</span> 어떻게 믿고<span class="font-pretendard">,</span> 어떻게 만들어내는지를 질문한다<span class="font-pretendard">.</span> 우리는 그들이 보여주는 이미지를 곧 그들 자신이라고 생각한다<span class="font-pretendard">.</span> 고도로 연출된 ‘완벽한 인간’을 받아들이며<span class="font-pretendard">,</span> 그것을 쉽게 숭배하고 이상화한다<span class="font-pretendard">.</span>
버츄얼 아이돌은 이 이미지 소비의 끝점에 서 있다<span class="font-pretendard">.</span> 그들은 무엇이든 될 수 있고<span class="font-pretendard">,</span> 어떤 모습이든 보여줄 수 있다<span class="font-pretendard">.</span>
하지만 그들은 진짜 사람일까<b><span class="font-pretendard">?</span></b>
우리가 생각하는 ‘사람다움’은 어디까지 허용될 수 있을까<b><span class="font-pretendard">?</span></b>
<b><span class="font-pretendard">ANGELITE</span></b>는 실재와 허구<span class="font-pretendard">,</span> 자아와 이미지<span class="font-pretendard">,</span> 감정과 알고리즘 사이의 긴장을 드러내는 프로젝트이다<span class="font-pretendard">.</span>
우리는 여전히 그들을 모른다<span class="font-pretendard">.</span>
그리고 어쩌면<span class="font-pretendard">,</span> 우리가 좋아하는 것은 그들이 아니라 ‘우리가 믿고 싶은 무엇’일지도 모른다<span class="font-pretendard">.</span>`,
...
export const cmykProjects = [
    {
        ...
        title: "WET TO DRY",
        year: "2025",
        descKo: `한국에서 수건은 종종 기쁜 축하의 순간에 선물하는 전통적인 물건이다<span class="font-pretendard">.</span> 생일<span class="font-pretendard">,</span> 돌잔치<span class="font-pretendard">,</span> 결혼식<span class="font-pretendard">,</span> 기념일 등을 기념하는 자수 문구가 새겨진 수건은 흔하게 볼 수 있으며<span class="font-pretendard">,</span> 일상의 리듬 속에 조용히 녹아 있는 작은 행복의 흔적이 된다<span class="font-pretendard">.</span>
하지만 나는 이런 일방적인 ‘기쁨’의 서사에 의문을 갖게 되었다<span class="font-pretendard">.</span> 수건은 기쁨을 기록하지만<span class="font-pretendard">,</span> 같은 날에 일어난 슬픔은 어디에 남겨야 할까<b><span class="font-pretendard">?</span></b> 누군가가 기뻐하는 바로 그 순간<span class="font-pretendard">,</span> 또 다른 누군가는 슬픔을 겪고 있을지도 모른다<span class="font-pretendard">.</span> 세상은 언제나 기쁨과 고통이 동시에 존재하는데<span class="font-pretendard">,</span> 우리는 왜 오직 기쁨만을 기념하려고 할까<b><span class="font-pretendard">?</span></b> 이 질문은 나로 하여금<span class="font-pretendard">,</span> 기쁨과 같은 무게와 존엄으로 슬픔도 기억하는 방식을 고민하게 만들었다<span class="font-pretendard">.</span>`,
...
This reflection led me to create a way to remember sorrow with the same weight and dignity we afford joy.</b>`,
        imageLayout: [
            ...
            { type: 'full', images: ['10.png'] },
            {
                ...
                title: "PAIN TONE",
                year: "2023",
                descKo: `나의 삶은 상처의 역사였다<span class="font-pretendard">.</span>
일정 기간 동안 내 몸에 생긴 멍과 상처들을 사진으로 기록했다<span class="font-pretendard">.</span> 자잘하고 무심하게 지나가는 상처들도<span class="font-pretendard">,</span> 깊고 오래 남은 흔적들도 모두 포함되었다<span class="font-pretendard">.</span> 그렇게 축적된 상처의 색을 추출해<span class="font-pretendard">,</span> 하나의 컬러 차트로 정리했다<span class="font-pretendard">.</span> 이 색상들은 <b><span class="font-pretendard">Adobe</span></b> 프로그램에서 사용할 수 있는 컬러 스와치로 재가공되었고<span class="font-pretendard">,</span> 나는 그 스와치를 기반으로 웹사이트<span class="font-pretendard">,</span> 출판물<span class="font-pretendard">,</span> 스티커 등 다양한 형식의 결과물을 제작했다<span class="font-pretendard">.</span>
상처는 아프고 지나가는 것이지만<span class="font-pretendard">,</span> 이 프로젝트는 그것들을 시각적 언어로 전환함으로써 내 삶의 흔적이자 기억으로 바라본다<span class="font-pretendard">.</span> 누군가에게는 감춰야 할 흔적일 수 있는 상처가<span class="font-pretendard">,</span> 여기서는 기록되고<span class="font-pretendard">,</span> 이름 붙여지고<span class="font-pretendard">,</span> 공유될 수 있는 색이 된다<span class="font-pretendard">.</span>
하지만 나는 이런 일방적인 ‘기쁨’의 서사에 의문을 갖게 되었다<span class="font-pretendard">.</span> 수건은 기쁨을 기록하지만<span class="font-pretendard">,</span> 같은 날에 일어난 슬픔은 어디에 남겨야 할까<b><span class="font-pretendard">?</span></b> 누군가가 기뻐하는 바로 그 순간<span class="font-pretendard">,</span> 또 다른 누군가는 슬픔을 겪고 있을지도 모른다<span class="font-pretendard">.</span> 세상은 언제나 기쁨과 고통이 동시에 존재하는데<span class="font-pretendard">,</span> 우리는 왜 오직 기쁨만을 기념하려고 할까<b><span class="font-pretendard">?</span></b> 이 질문은 나로 하여금<span class="font-pretendard">,</span> 기쁨과 같은 무게와 존엄으로 슬픔도 기억하는 방식을 고민하게 만들었다<span class="font-pretendard">.</span>`,
